package grizzlybear1024.snowaccumulation.common;
...
public class SnowAccumulationTickHandler {
	...
	@SubscribeEvent
	public void worldTickEvent(WorldEvent e){
	    if(e.getWorld() instanceof ServerWorld)
	    {
	    	ServerWorld worldserver = (ServerWorld) e.getWorld();
	    	...
	    	{	
	    		try
	    		{
	    			...
	    			for (ChunkHolder chunkHolder : chunkContainer)
		    		{
		    			...
		    			if (worldserver.dimension.canDoRainSnowIce(chunk) && worldserver.rand.nextInt(64) == 0 )
		    			{
